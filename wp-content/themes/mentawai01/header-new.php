...
<head>
	...
	<link rel="stylesheet" id="737-layout.css-css" href="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/737-layout.css" type="text/css" media="all">
...
<div class="login_register_stuff"></div><!-- end login register stuff -->
	...
	<header id="header"
							...
							<div class="fxb-row site-header-row site-header-main ">
								...
								<div
									...
									<div id="logo-container"
										...
										<!-- Logo -->
										<!-- <h1 class="site-logo logo " id="logo"><a href="https://thesurfingmentawai.com/"
												class="site-logo-anch"><img class="logo-img-sticky site-logo-img-sticky"
													...
													data-mobile-logo="https://thesurfingmentawai.com/wp-content/uploads/2023/07/Logo-utama.png"></a>
										</h1>  -->
										<!-- InfoCard -->
									</div>
		...
		<div
        class="zn_pb_wrapper clearfix zn_sortable_content"
        data-droplevel="0"
      >
        <div
          id="page_header"
          class="page-subheader maskcontainer-- page-subheader--custom site-subheader-cst uh_zn_def_header_style eluid55c8baee psubhead-stheader--absolute sh-tcolor--light"
        >
          ...
          <div class="zn-bgSource">
            <div
              ...
              style="
                background-image: url(https://mentawai-surfingbarrels.com/wp-content/uploads/2023/03/55024Zorba-Tulum_JPG.jpg);
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <ul
                        ...
                        class="breadcrumbs fixclear bread-style--black"
                      >
                      ...
                      <span
                        id="current-date"
                        class="subheader-currentdate hidden-xs"
                        ><div class="meta mb-1"><?php the_date()?></div></span
                      >
                    ...
                    <div class="col-sm-6">
                      <div class="subheader-titles">
                        <h3 class="subheader-maintitle" itemprop="headline">
						<?php the_title()?>
                        </h3>
                      </div>
                    </div>
          ...
          <div class="kl-mask kl-bottommask kl-mask-- kl-mask--light"></div>
        <!-- </div>
    </div> -->
