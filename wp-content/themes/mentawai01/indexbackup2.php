...
<head>
	...
	<link rel="icon"
		href="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/logo-utama.png"
		sizes="192x192">
...
<body class="home page-template-default page page-id-673 res1170 kl-sticky-header kl-skin--light" itemscope="itemscope">
				...
				<!-- start main_menu -->	
					<div style="display: table; width: 50%;">
						<!-- <div style="display: table-cell; vertical-align: middle;">
							...
							if ( has_custom_logo() ) {
									echo '<a href="' .get_site_url(). '"><img class="containerLogo" src="' . $logo[0] . '" alt="' . get_bloginfo( 'name' ) . '" height="34px" style="margin-top: 10px;"></a>';
							} else {
	...
	<!-- <script type="text/javascript" src="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/znscript.min.js?ver=4.17.1"></script> -->
	<script type="text/javascript" src="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/SmoothScroll.min.js?ver=4.17.1"></script>
