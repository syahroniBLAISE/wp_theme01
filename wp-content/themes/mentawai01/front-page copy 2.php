	...
	<script type="application/ld+json" class="yoast-schema-graph">
		{
			...
			"@graph": [{
				"@type": "WebSite",
				"@id": "https://surfcampsiberut.com/#website",
				"url": "https://surfcampsiberut.com/",
				"name": "Cheapest Surf Trip Mentawai at Padang Sumatera Barat Indonesia",
				"description": "Cheapest Surf Trip Siberut At Padang Sumatera Barat",
				"potentialAction": [{
					"@type": "SearchAction",
					"target": "https://surfcampsiberut.com/?s={search_term_string}",
					"query-input": "required name=search_term_string"
				}],
				"inLanguage": "en-US"
			}, {
				"@type": "WebPage",
				"@id": "https://surfcampsiberut.com/#webpage",
				"url": "https://surfcampsiberut.com/",
				"name": "Mentawai Homepage - Cheapest Surf Trip Siberut",
				"isPartOf": {
					"@id": "https://surfcampsiberut.com/#website"
				},
				"datePublished": "2016-06-17T10:24:41+00:00",
				"dateModified": "2023-07-10T08:19:13+00:00",
				"inLanguage": "en-US",
				"potentialAction": [{
					"@type": "ReadAction",
					"target": ["https://surfcampsiberut.com/"]
				}]
			}]
		}
	</script>
...
<body class="home page-template-default page page-id-673 res1170 kl-sticky-header kl-skin--light" itemscope="itemscope">
	...
	<div id="page_wrapper" class style="height: auto;">
							...
							<div
								...
								<div class="znColumnElement-innerContent">
									<div
										...
										<div class="tbk__text">
											<p style="text-align: left;"><strong>waves are on foot distance with surf spot in front of our camp and many more waves by boat.
waves are in speed boat distance with surf spot in front of our camp and many more waves by boat.</strong></p>
										</div>
									</div>
								</div>
							</div>
							...
							<div
								...
								<div class="znColumnElement-innerContent">
									...
									<div id="eluid107643e2" class="zn_buttons_element eluid107643e2 text-left "><a
											href="https://api.whatsapp.com/send?phone=6281374006060" target="_blank" id="eluid107643e20"
													...
													<div class="znColumnElement-innerContent">
														<div class="eluidc6631c07  zn-SliderEl clearfix zn-SliderEl--view"
															...
															<div
																...
																<span onclick="plusSlides(-1)" class="znSlickNav-arr znSlickNav-prev slick-arrow"
																	...
																	</svg></span><span onclick="plusSlides(1)"
															...
															<div class="zn-Slider zn-Slider-eluidc6631c07 zn-Slider--cols1 js-slick mfp-gallery mfp-gallery--misc slick-initialized slick-slider slickSlider--activated"
																...
																<div class="slick-list draggable">
																	<div class="slick-track"
																		...
																		<?php 
																		$data = ["gambar01.jpg","gambar02.jpg","gambar03.jpg"];
																		$i = 0;
																		foreach ($data as $d) { ?>
																			<!-- <h2>test</h2> -->
																			<div class="zn-Slider-item slick-slide slick-cloned"
																				data-title="" data-slick-index="<?php echo($i);?>"
																				...
																				tabindex="-1">
																					...
																					tabindex="-1"><img
																					src="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/img/<?php echo($d) ?>"
																			...
																			<!-- <div class="mySlides fade">
																				...
																				<img src="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/img/<?php echo($d) ?>" style="width:100%">
							...
							<div
								...
								<div class="znColumnElement-innerContent">
									...
									<div id="eluid836349e2" class="zn_buttons_element eluid836349e2 text-left "><a
											href="https://api.whatsapp.com/send?phone=6281374006060" target="_blank" id="eluid836349e20"
							...
							<div
								...
								<div class="znColumnElement-innerContent">
									...
									<div id="eluidda12940e" class="zn_buttons_element eluidda12940e text-center "><a
											href="https://api.whatsapp.com/send?phone=6281374006060" target="_blank" id="eluidda12940e0"
											...
											target="_blank" rel="noopener" itemprop="url"><span class="btn-element-icon"
												...
												data-zn_icon=""></span><span>+6281374006060</span></a></div>
								</div>
							</div>
								...
								<div
									...
									<div class="znColumnElement-innerContent">
										<div id="eluid3b30cf52" class="zn_buttons_element eluid3b30cf52 text-center "><a
												href="https://api.whatsapp.com/send?phone=6281374006060" target="_blank" id="eluid3b30cf520"
							...
							<div class="eluid97524b63            col-md-12 col-sm-12   znColumnElement"
								...
								<div
									...
									<div class="znColumnElement-innerContent">
										...
										<div class="container col-md-4 col-sm-4"></div>
										<div class="container text-left col-md-4 col-sm-4">
											<div class="footerwidget">
												<h3 class="text-center">Last Post</h3>
				...
				<section class="zn_section eluid22868419     section-sidemargins    section--no " id="eluidb0a6f970">
					...
					<div class="zn_section_size container zn-section-height--auto zn-section-content_algn--top ">
						...
						<div class="row text-center">
							...
							<div class="eluid6a1e625c            col-md-12 col-sm-12   znColumnElement"
								id="eluideb6da656">
									...
									<div class="znColumnElement-innerContent">
										<div class="zn_text_box eluid182ce248  zn_text_box-light element-scheme--light">
											<p><span style="font-size: 12px;"><span
														style="color: #ffffff; text-transform: uppercase;">© 2023 <span
															style="color: #ff0000;"><a style="color: #ffffff;"
																href="https://mentawai-surfingbarrels.com/"
																target="">thesurfmentawai</a></span>&nbsp;| All rights
													...
													style="font-size: 12px;"><span
														...
														by <a href="https://puplas.com/"><span
																style="color: #ffffff; text-transform: uppercase;">www.partnersablon.com</span></a>.</span></span>
											</p>
										</div>
									</div>
								</div>
	...
	<a href="<?php echo get_bloginfo('url') ?>/#" id="totop" class="u-trans-all-2s js-scroll-event" data-forch="300"
	...
	<!-- <script type="text/javascript" src="<?php echo bloginfo("stylesheet_directory"); ?>/fileTheme/znscript.min.js.download"></script> -->
